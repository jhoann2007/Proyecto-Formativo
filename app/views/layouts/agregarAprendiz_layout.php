...
<body class="index-page">
    ...
    <header id="header" class="header dark-background d-flex flex-column">
        <div class="profile-img">
            <img src="/img/yo.jpg" alt="" class="img-fluid rounded-circle">
        </div>
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li><a href="/agregarAprendiz"><i class="bi bi-person-fill-add"></i>&nbsp;&nbsp;&nbsp;Agregar
                        Aprendiz</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main class="main">
        <div class="container mt-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex gap-2">
                    <button class="btn btn-outline-dark bi bi-person-fill-add" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="modalAprendiz" tabindex="-1" aria-labelledby="modalAprendizLabel"
            aria-hidden="true">
